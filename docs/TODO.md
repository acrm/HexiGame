...
- [x] Механизм подсветки точек интереса за границей видимости: полностью видимые цели показывают 6 точек углов, частично невидимые — 2 точки на границе, удалённые — 1 точка
