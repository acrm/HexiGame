...
- [x] Intro-modal для заданий туториала открывается по клику на виджет, содержит кнопки «Начать/Отложить», а виджет работает по фазам pending/active/complete
...
- [x] Механизм подсветки точек интереса за границей видимости: полностью видимые цели показывают 6 точек углов, частично невидимые — 2 точки на границе видимого игрового поля, удалённые — 1 точка
