...
- Off-screen point-of-interest highlighting preserves the target's nearest visible face on the field contour: markers snap only to real rendered contour vertices (no synthetic offsets) and blink with stronger white glow than on-screen target dots.
